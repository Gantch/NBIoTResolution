...
//    private httpRequest hr = new httpRequest();
    ...
    String ips = null;
    public UdpServerHandler(UplinkService uplinkService,NbiotDeviceService nbiotDeviceService,DeviceRelationDao relationDao,NbiotAlarmLogDao nbiotAlarmLogDao,DeviceMessageDao deviceMessageDao,RedisMsgService msgService){
    ...
    protected void channelRead0(ChannelHandlerContext ctx, DatagramPacket msg) throws Exception {
        ...
        if(frameType == (byte) 0x81){//当前的帧类型为“硬件请求数据”
            ...
            dataService.resolution(validData,dataLength,mac,nbiotDeviceService,relationDao,nbiotAlarmLogDao,deviceMessageDao,msgService);
        }
    }
