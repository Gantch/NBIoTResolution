...
public interface NbiotAlarmLogMapper {
    @Insert("INSERT INTO nbiot_alarm_log(deviceId,timestamp,name,latitude,longitude,alarmType,tenant_id) VALUES (#{deviceId},#{timestamp},#{name},#{latitude},#{longitude},#{alarmType},#{tenantId})")
